...
public class CreateU81Minus10Stations {
	...
	public static void main(String[] args) {
		...
		var stop4_n_s=scheduleFactory.createTransitRouteStop(stop4_facility_n_s,357,387);
		var stop5_n_s=scheduleFactory.createTransitRouteStop(stop5_facility_n_s,561,591);
		var stop6_n_s=scheduleFactory.createTransitRouteStop(stop6_facility_n_s,738,753);
		/*var stop7_n_s=scheduleFactory.createTransitRouteStop(stop7_facility_n_s,803,818);*/
		/*var stop8_n_s=scheduleFactory.createTransitRouteStop(stop8_facility_n_s,888,903);*/
		var stop9_n_s=scheduleFactory.createTransitRouteStop(stop9_facility_n_s,1112,1127);
		var stop10_n_s=scheduleFactory.createTransitRouteStop(stop10_facility_n_s,1167,1182);
		var stop11_n_s=scheduleFactory.createTransitRouteStop(stop11_facility_n_s,1222,1237);
		var stop12_n_s=scheduleFactory.createTransitRouteStop(stop12_facility_n_s,1347,1362);
		/*var stop13_n_s=scheduleFactory.createTransitRouteStop(stop13_facility_n_s,1523,1538);*/
		var stop14_n_s=scheduleFactory.createTransitRouteStop(stop14_facility_n_s,1482,1512);
		/*var stop15_n_s=scheduleFactory.createTransitRouteStop(stop15_facility_n_s,1708,1723);*/
		/*var stop16_n_s=scheduleFactory.createTransitRouteStop(stop16_facility_n_s,1803,1818);*/
		/*var stop17_n_s=scheduleFactory.createTransitRouteStop(stop17_facility_n_s,1878,1893);*/
		var stop18_n_s=scheduleFactory.createTransitRouteStop(stop18_facility_n_s,1759,1774);
		/*var stop19_n_s=scheduleFactory.createTransitRouteStop(stop19_facility_n_s,2028,2043);*/
		var stop20_n_s=scheduleFactory.createTransitRouteStop(stop20_facility_n_s,1884,1899);
		/*var stop21_n_s=scheduleFactory.createTransitRouteStop(stop21_facility_n_s,2168,2183);*/
		/*var stop22_n_s=scheduleFactory.createTransitRouteStop(stop22_facility_n_s,2233,2248);*/
		/*var stop23_n_s=scheduleFactory.createTransitRouteStop(stop23_facility_n_s,2328,2343);*/
		var stop24_n_s=scheduleFactory.createTransitRouteStop(stop24_facility_n_s,2110,2140);
		...
		/*var stop4_s_n=scheduleFactory.createTransitRouteStop(stop4_facility_s_n,210,225);*/
		var stop5_s_n=scheduleFactory.createTransitRouteStop(stop5_facility_s_n,209,224);
		/*var stop6_s_n=scheduleFactory.createTransitRouteStop(stop6_facility_s_n,350,365);*/
		var stop7_s_n=scheduleFactory.createTransitRouteStop(stop7_facility_s_n,324,339);
		/*var stop8_s_n=scheduleFactory.createTransitRouteStop(stop8_facility_s_n,500,515);*/
		/*var stop9_s_n=scheduleFactory.createTransitRouteStop(stop9_facility_s_n,575,590);*/
		/*var stop10_s_n=scheduleFactory.createTransitRouteStop(stop10_facility_s_n,670,685);*/
		var stop11_s_n=scheduleFactory.createTransitRouteStop(stop11_facility_s_n,583,613);
		/*var stop12_s_n=scheduleFactory.createTransitRouteStop(stop12_facility_s_n,855,870);*/
		var stop13_s_n=scheduleFactory.createTransitRouteStop(stop13_facility_s_n,732,747);
		var stop14_s_n=scheduleFactory.createTransitRouteStop(stop14_facility_s_n,857,872);
		var stop15_s_n=scheduleFactory.createTransitRouteStop(stop15_facility_s_n,912,927);
		var stop16_s_n=scheduleFactory.createTransitRouteStop(stop16_facility_s_n,967,982);
		/*var stop17_s_n=scheduleFactory.createTransitRouteStop(stop17_facility_s_n,1490,1505);*/
		/*var stop18_s_n=scheduleFactory.createTransitRouteStop(stop18_facility_s_n,1575,1590);*/
		var stop19_s_n=scheduleFactory.createTransitRouteStop(stop19_facility_s_n,1383,1398);
		var stop20_s_n=scheduleFactory.createTransitRouteStop(stop20_facility_s_n,1545,1575);
		var stop21_s_n=scheduleFactory.createTransitRouteStop(stop21_facility_s_n,1749,1779);
		var stop22_s_n=scheduleFactory.createTransitRouteStop(stop22_facility_s_n,1966,1981);
		var stop23_s_n=scheduleFactory.createTransitRouteStop(stop23_facility_s_n,2061,2076);
		var stop24_s_n=scheduleFactory.createTransitRouteStop(stop24_facility_s_n,2136,2151);
		...
		for (int i = 0 * 3600; i < 24 * 3600; i += 1200) {
		...
		new NetworkWriter(network).write(root.resolve("network-with-U81Minus10Stations-20min.xml.gz").toString());
		new TransitScheduleWriter(scenario.getTransitSchedule()).writeFile(root.resolve("transit-Schedule-U81Minus10Stations-20min.xml.gz").toString());
		new MatsimVehicleWriter(scenario.getTransitVehicles()).writeFile(root.resolve("transit-vehicles-U81Minus10Stations-20min.xml.gz").toString());
