...
public class CreateFastU81 {
	...
	public static void main(String[] args) {
		...
		var stop2_n_s=scheduleFactory.createTransitRouteStop(stop2_facility_n_s,600,610);
		var stop3_n_s=scheduleFactory.createTransitRouteStop(stop3_facility_n_s,1200,1210);
		var stop4_n_s=scheduleFactory.createTransitRouteStop(stop4_facility_n_s,1800,1810);
		var stop5_n_s=scheduleFactory.createTransitRouteStop(stop5_facility_n_s,2400,2410);
		var stop6_n_s=scheduleFactory.createTransitRouteStop(stop6_facility_n_s,3000,3010);
		var stop7_n_s=scheduleFactory.createTransitRouteStop(stop7_facility_n_s,3600,3610);
		var stop8_n_s=scheduleFactory.createTransitRouteStop(stop8_facility_n_s,4200,4210);
		var stop9_n_s=scheduleFactory.createTransitRouteStop(stop9_facility_n_s,4800,4810);
		var stop10_n_s=scheduleFactory.createTransitRouteStop(stop10_facility_n_s,5400,5410);
		var stop11_n_s=scheduleFactory.createTransitRouteStop(stop11_facility_n_s,6000,6010);
		var stop12_n_s=scheduleFactory.createTransitRouteStop(stop12_facility_n_s,6600,6610);
		var stop13_n_s=scheduleFactory.createTransitRouteStop(stop13_facility_n_s,7200,7210);
		var stop14_n_s=scheduleFactory.createTransitRouteStop(stop14_facility_n_s,7800,7810);
		var stop15_n_s=scheduleFactory.createTransitRouteStop(stop15_facility_n_s,8400,8410);
		var stop16_n_s=scheduleFactory.createTransitRouteStop(stop16_facility_n_s,9000,9010);
		var stop17_n_s=scheduleFactory.createTransitRouteStop(stop17_facility_n_s,9600,9610);
		var stop18_n_s=scheduleFactory.createTransitRouteStop(stop18_facility_n_s,10200,10210);
		var stop19_n_s=scheduleFactory.createTransitRouteStop(stop19_facility_n_s,10800,10810);
		var stop20_n_s=scheduleFactory.createTransitRouteStop(stop20_facility_n_s,11400,11410);
		var stop21_n_s=scheduleFactory.createTransitRouteStop(stop21_facility_n_s,12000,12010);
		var stop22_n_s=scheduleFactory.createTransitRouteStop(stop22_facility_n_s,12600,12610);
		var stop23_n_s=scheduleFactory.createTransitRouteStop(stop23_facility_n_s,13200,13210);
		var stop24_n_s=scheduleFactory.createTransitRouteStop(stop24_facility_n_s,14400,14410);


		// stations n > s
		var stop1_s_n=scheduleFactory.createTransitRouteStop(stop1_facility_s_n,0,0);
		var stop2_s_n=scheduleFactory.createTransitRouteStop(stop2_facility_s_n,600,610);
		var stop3_s_n=scheduleFactory.createTransitRouteStop(stop3_facility_s_n,1200,1210);
		var stop4_s_n=scheduleFactory.createTransitRouteStop(stop4_facility_s_n,1800,1810);
		var stop5_s_n=scheduleFactory.createTransitRouteStop(stop5_facility_s_n,2400,2410);
		var stop6_s_n=scheduleFactory.createTransitRouteStop(stop6_facility_s_n,3000,3010);
		var stop7_s_n=scheduleFactory.createTransitRouteStop(stop7_facility_s_n,3600,3610);
		var stop8_s_n=scheduleFactory.createTransitRouteStop(stop8_facility_s_n,4200,4210);
		var stop9_s_n=scheduleFactory.createTransitRouteStop(stop9_facility_s_n,4800,4810);
		var stop10_s_n=scheduleFactory.createTransitRouteStop(stop10_facility_s_n,5400,5410);
		var stop11_s_n=scheduleFactory.createTransitRouteStop(stop11_facility_s_n,6000,6010);
		var stop12_s_n=scheduleFactory.createTransitRouteStop(stop12_facility_s_n,6600,6610);
		var stop13_s_n=scheduleFactory.createTransitRouteStop(stop13_facility_s_n,7200,7210);
		var stop14_s_n=scheduleFactory.createTransitRouteStop(stop14_facility_s_n,7800,7810);
		var stop15_s_n=scheduleFactory.createTransitRouteStop(stop15_facility_s_n,8400,8410);
		var stop16_s_n=scheduleFactory.createTransitRouteStop(stop16_facility_s_n,9000,9010);
		var stop17_s_n=scheduleFactory.createTransitRouteStop(stop17_facility_s_n,9600,9610);
		var stop18_s_n=scheduleFactory.createTransitRouteStop(stop18_facility_s_n,10200,10210);
		var stop19_s_n=scheduleFactory.createTransitRouteStop(stop19_facility_s_n,10800,10810);
		var stop20_s_n=scheduleFactory.createTransitRouteStop(stop20_facility_s_n,11400,11410);
		var stop21_s_n=scheduleFactory.createTransitRouteStop(stop21_facility_s_n,12000,12010);
		var stop22_s_n=scheduleFactory.createTransitRouteStop(stop22_facility_s_n,12600,12610);
		var stop23_s_n=scheduleFactory.createTransitRouteStop(stop23_facility_s_n,13200,13210);
		var stop24_s_n=scheduleFactory.createTransitRouteStop(stop24_facility_s_n,14400,14410);
		...
		for (int i = 0 * 3600; i < 24 * 3600; i += 300) {
			...
			var vehicle = scenario.getTransitVehicles().getFactory().createVehicle(Id.createVehicleId("U81_vehicle_ns_" + i), vehicleType);
		...
		for (int i = 0 * 3600; i < 24 * 3600; i += 300) {
			var departure = scheduleFactory.createDeparture(Id.create("departure_" + i, Departure.class), i);
			var vehicle = scenario.getTransitVehicles().getFactory().createVehicle(Id.createVehicleId("U81_vehicle_sn_" + i), vehicleType);
			departure.setVehicleId(vehicle.getId());
