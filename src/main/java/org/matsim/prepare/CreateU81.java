...
public class CreateU81 {
	...
	public static void main(String[] args) {
		...
		var stop9_n_s=scheduleFactory.createTransitRouteStop(stop9_facility_n_s,1203,1218);
		var stop10_n_s=scheduleFactory.createTransitRouteStop(stop10_facility_n_s,1258,1273);
		var stop11_n_s=scheduleFactory.createTransitRouteStop(stop11_facility_n_s,1313,1328);
		var stop12_n_s=scheduleFactory.createTransitRouteStop(stop12_facility_n_s,1438,1453);
		var stop13_n_s=scheduleFactory.createTransitRouteStop(stop13_facility_n_s,1523,1538);
		var stop14_n_s=scheduleFactory.createTransitRouteStop(stop14_facility_n_s,1598,1628);
		...
		var stop18_n_s=scheduleFactory.createTransitRouteStop(stop18_facility_n_s,1953,1968);
		var stop19_n_s=scheduleFactory.createTransitRouteStop(stop19_facility_n_s,2028,2043);
		var stop20_n_s=scheduleFactory.createTransitRouteStop(stop20_facility_n_s,2093,2108);
		...
		var stop5_s_n=scheduleFactory.createTransitRouteStop(stop5_facility_s_n,285,300);
		var stop6_s_n=scheduleFactory.createTransitRouteStop(stop6_facility_s_n,350,365);
		var stop7_s_n=scheduleFactory.createTransitRouteStop(stop7_facility_s_n,425,440);
		...
		var stop11_s_n=scheduleFactory.createTransitRouteStop(stop11_facility_s_n,765,795);
		var stop12_s_n=scheduleFactory.createTransitRouteStop(stop12_facility_s_n,855,870);
		var stop13_s_n=scheduleFactory.createTransitRouteStop(stop13_facility_s_n,940,955);
		var stop14_s_n=scheduleFactory.createTransitRouteStop(stop14_facility_s_n,1065,1080);
		var stop15_s_n=scheduleFactory.createTransitRouteStop(stop15_facility_s_n,1120,1135);
		var stop16_s_n=scheduleFactory.createTransitRouteStop(stop16_facility_s_n,1175,1190);
		...
		var stop19_s_n=scheduleFactory.createTransitRouteStop(stop19_facility_s_n,1640,1655);
		var stop20_s_n=scheduleFactory.createTransitRouteStop(stop20_facility_s_n,1802,1832);
		var stop21_s_n=scheduleFactory.createTransitRouteStop(stop21_facility_s_n,2006,2036);
		var stop22_s_n=scheduleFactory.createTransitRouteStop(stop22_facility_s_n,2223,2238);
		var stop23_s_n=scheduleFactory.createTransitRouteStop(stop23_facility_s_n,2318,2333);
		var stop24_s_n=scheduleFactory.createTransitRouteStop(stop24_facility_s_n,2393,2408);
